// From https://github.com/discordjs/discord-api-types/blob/main/scripts/actions/create-release.mjs
...
console.log(`🎉 Creating new release for denyard ${packageJson.version}`);
